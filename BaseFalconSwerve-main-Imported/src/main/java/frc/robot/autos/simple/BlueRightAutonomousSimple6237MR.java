...
public class BlueRightAutonomousSimple6237MR  extends SequentialCommandGroup implements IAutonomousPath6237MR {
    @Override
    ...
    public BlueRightAutonomousSimple6237MR(SwerveSubsystem s_Swerve, ArmSubsystem arm, LauncherSubsystem launcher, IntakeSubsystem intake){
